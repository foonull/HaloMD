...
PixelShader PS_SpecularLightFlat_ps_1_4 = asm
{
    #define T0 c0
    #define T1 r1
    ...
    +dp3_sat R0.rgb, T0, T2_bx2										           	// N.E

	//combiner 1
    mov_x8_sat D1.a, T2_bx2.b													// self-shadow mask (E.z*8)
    +mad_x2_sat R1.rgb, T0, R0, -T2_bias										// 2N(N.E)-E
...
Technique ps_1_4
{
    Pass P0
	{
		...
		PixelShader = asm
		{
			TEMP t0, t1, t2, t3, t4, t5, t6, t7, tmp0, tmp1, tmp2, r0, r1, r2, r3, r4;
			...
			PARAM c0 = {0.000000, 0.000000, 1.000000, 0.000000};
		...
		//PixelShader = (PS_SpecularLightFlat_ps_1_4);
 	}
}
