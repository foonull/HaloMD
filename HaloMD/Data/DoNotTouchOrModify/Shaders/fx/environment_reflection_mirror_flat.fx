...
half4 EnvironmentReflectionMirrorFlat(
    half4 Diff : COLOR0,
...
Technique ps_2_0
{
    Pass P0
	{
		...
		PixelShader = compile PS_2_0_TARGET EnvironmentReflectionMirrorFlat();
 	}
}


PixelShader PS_EnvironmentReflectionMirrorFlat_ps_1_4 = asm
{
    #define T0 r0
...
Technique ps_1_4
{
	Pass P0
	{
		...
		PixelShader = (PS_EnvironmentReflectionMirrorFlat_ps_1_4);
	}
}
*/
Technique ps_1_1
