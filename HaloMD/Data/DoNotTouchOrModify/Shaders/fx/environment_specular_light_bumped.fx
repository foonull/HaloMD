...
PixelShader PS_SpecularLightBumped_ps_1_4 = asm
{
    #define T0 r0
...
//  mul T1.rgb, T0, T1															// gel, specular mask (optionally used)
    ...
    dp3 T0.rgb, T1, c_specular_brightness
...
Technique ps_1_4
{
    Pass P0
	{
		...
		//PixelShader = (PS_SpecularLightBumped_ps_1_4);
 	}
}
