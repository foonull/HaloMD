...
MUL oT1.xy, r10, c[10];  # detail map
...
MAX r8.xy, r8, v4.z;                         # clamp to zero
MUL r8.xy, r8, r8;                  # {(1 - x)^2, (1 - y)^2}
MIN r8.xy, r8, v4.w;                          # clamp to one
