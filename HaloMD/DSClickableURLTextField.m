...
- (void)mouseUp:(NSEvent *)mouseEvent
{
	...
	if ( (urlAtMouse != nil)  &&  [urlAtMouse isEqualTo:clickedURL] ) {
		...
		if ( ([self delegate] == nil)  || ![[self delegate] respondsToSelector:@selector(textField:openURL:)] || ![(id <DSClickableURLTextFieldProtocol>)[self delegate] textField:self openURL:urlAtMouse] )
